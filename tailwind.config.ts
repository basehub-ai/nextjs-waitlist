...
const config: Config = {
    ...
    theme: {
        ...
        fontSize: {
            ...
            sm: [
                '0.875rem',
                { lineHeight: '1.25rem', letterSpacing: '-0.42px' },
            ],
            base: ['1rem', { lineHeight: '1.6', letterSpacing: '-0.48px' }],
            lg: [
                '1.125rem',
                { lineHeight: '1.75rem', letterSpacing: '-0.72px' },
            ],
            xl: ['1.25rem', { lineHeight: '1.75rem', letterSpacing: '-0.8px' }],
            '2xl': ['1.5rem', { lineHeight: '2rem', letterSpacing: '-1.12px' }],
            '3xl': [
                '1.75rem',
                { lineHeight: '2.25rem', letterSpacing: '-1.2px' },
            ],
            '4xl': [
                '2.25rem',
                { lineHeight: '2.5rem', letterSpacing: '-1.44px' },
            ],
